...
To \texttt{FlightLogger} class has then been given the task of logging every step of the GPS of the drone, along with the currently set glitch and any events that may occur during the spoofing period.
